...
\]
Dabei implizieren wir, dass die Annäherung $x\rightarrow a$ mittels einer Cauchy-Folge erreicht wird. Durch Multiplikation von $|x-a|$ auf beiden Seiten erhalten wir:
\[

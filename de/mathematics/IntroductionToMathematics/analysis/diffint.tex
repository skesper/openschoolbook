...
\]
ist. Dies ist nichts ungewöhnliches. Wir sagen damit lediglich, dass $|S_f(x,a) - S_f| \rightarrow 0$ für $x\rightarrow a$. Und das haben wir ja durch (\ref{eq:slim}) schon vorausgesetzt.
...
\]
Der Sehengrenzwert wird auch als \textsl{Tangente} bezeichnet. 

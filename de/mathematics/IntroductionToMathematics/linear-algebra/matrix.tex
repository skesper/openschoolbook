...
Betrachten wir den dreidimensionalen reellen Vektorraum. Speziell für den dreidimensionalen Fall können wir eine Operation definieren, die einem Produkt auf dem Vektorraum entspricht. Wir nennen es das \textsl{Kreuzprodukt} oder \textsl{äußeres Produkt}. 

\begin{definition}
Das \textsl{Kreuzprodukt} ist definiert für Vektoren $u,v\in \mathbb{R}^3$, als
\begin{equation*}
\begin{pmatrix}
u_1\\u_2\\u_3
\end{pmatrix} \times 
...
\begin{definition}
Der Vektorraum zusammen mit diesem Produkt wird eine \textsl{Algebra}\index{Algebra} genannt.
\end{definition}

Der $\mathbb{R}^3$ zusammen mit dem Kreuzprodukt bildet eine sehr einfache \textsl{Lie-Algebra}\footnote{benannt nach dem norwegischen Mathematiker \textbf{Marius Sophus Lie}, *17. Dezember 1842 in Nordfjordeid; \ding{61}18. Februar 1899 in Kristiania (Oslo)}. Eine Lie-Algebra findet in der Differentialgeometrie und der physikalischen Mathemtik Anwendung. Sie ist definiert durch:

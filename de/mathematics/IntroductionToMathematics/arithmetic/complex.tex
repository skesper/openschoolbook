...
\begin{definition}
Eine unendliche Menge, deren Elemente durchgezählt werden können, also in denen jedem Element eine natürliche Zahl zugeordnet werden kann, nennt man \textsl{abzählbar unendlich}. \index{abzählbar} \index{abzählbar unendlich}
\end{definition}

...
\begin{definition}
Dies bezeichnen wir als \emph{Division mit Rest}. \index{Division mit Rest}
\end{definition}
...
\begin{definition}
Eine Teilerform nennt man einen \emph{Bruch}\index{Bruch}, sowie das Rechnen mit Brüchen \emph{Bruchrechnung}.\index{Bruchrechnung}
\end{definition}
...
\]
In diesem Fall sagt man, dass man den Bruch um $a$ \emph{kürzen}\index{kürzen} kann.
\end{definition}
...
\begin{definition}
Eine \emph{Dezimalzahl} ist eine Zahl der folgenden Form:\index{Dezimalzahl}
...
\begin{definition}
Die Zahl, die potenziert werden soll, nennt man \emph{Grundzahl}\index{Grundzahl}, und die Zahl mit der potenziert werden soll \emph{Hochzahl}\index{Hochzahl}, oder \emph{Exponent}\index{Exponent}. Den Wert der Potenz einer Grundzahl ($a$) mit einer natürlichen Zahl ($n \in \mathbb{N}$) als Exponent erhält man durch:
...
Das meist weggelassene $+$ vor den Zahlen, sowie das $-$ wird als \emph{Vorzeichen} bezeichnet. Die folgende Definition ist daher naheliegend, wenn auch zu diesem Stadium noch nicht weiter von Interesse:
